...
public final class Messages {
	...
	private static final Map<Key, String> EN = Map.ofEntries(
			...
			Map.entry(Key.CFG_HELP, "Options: lang, drop, reopen, return, walk, online, dm, trigger (add/remove/list), members, reqmember, watch (add/remove/list), unwatch, chatlog, whisper, master, sethome, come, goto, stop, returnpos, help"),
